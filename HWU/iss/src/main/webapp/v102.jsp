<html>
    <body>
        ...
        <div>
            ...
            <p>Hitting EBI endpoint: <%= org.bisel.phis.iss.client.GetISSURL.getEBI("102")%></p>
        </div>
        ...
        <h3>Instructions</h3>
        <div>
            <p>This is API v102, to use it append &version=102 to your URL.</p>             
        </div>
        ...
        <div>    
            <h4>Examples:</h4>    
            <ol>
                <li><a href="<%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Annotation?action=create&phisid=abc123X19078p&version=102&creatorid=solomon&imageid=emage_EMAGE_1218.1&x_value=33.333333333333336&x_value=63.75661375661376&y_value=42.79661026949152&y_value=70.33898305084746&z_value=0&z_value=0&dpt_anatomy_term=body%20cavity%20or%20lining&dpt_anatomy_term=anatomical%20cluster&dpt_anatomyid=EMAP:3144&dpt_anatomyid=EMAP:3144"><%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Annotation?action=create&phisid=abc123X19078p&version=102&creatorid=solomon&imageid=emage_EMAGE_1218.1&x_value=33.333333333333336&x_value=63.75661375661376&y_value=42.79661026949152&y_value=70.33898305084746&z_value=0&z_value=0&dpt_anatomy_term=body%20cavity%20or%20lining&dpt_anatomy_term=anatomical%20cluster&dpt_anatomyid=EMAP:3144&dpt_anatomyid=EMAP:3144</a>                            
                <li><a href="<%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Annotation?action=delete&phisid=abc123X19078p&version=102&creatorid=solomon"><%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Annotation?action=delete&phisid=abc123X19078p&version=102&creatorid=solomon</a>                            
            </ol>    
        </div>
        ...
        <div>
            <h4>Examples</h4>
            <ol>
                <li><a href="<%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Id?version=102"><%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Id?version=102</a></p></li>
            </ol>
        </div>                                  
    </body>
</html>
