...
QUnit.test( "Add annotation (action=create,creatorid=solomon,phisid=roi_ua_testX19776P,imageid=emage_EMAGE_1218.1)", function( assert ) {
...
//Annotation APIs
QUnit.test( "Update annotation - dpt_anatomyid, dpt_anatomy_term and dpt_anatomy_text endpoints (action=edit,creatorid=solomon,phisid=roi_ua_testX19776P,imageid=emage_EMAGE_1218.1)", function( assert ) {
...
QUnit.test( "Update annotation - testing phenotypeid, phenotype_text & phenotype_terms (action=edit,creatorid=solomon,phisid=roi_ua_testX19776P,imageid=emage_EMAGE_1218.1, phenotypeid = (EMAP:41447, EMAP:414456),  phenotype_terms = (cornea ulcer, cornea opacity), phenotype_text = (cornea ulcer text,cornea opacity text))", 
...
//Annotation APIs - editing annotation
QUnit.test( "Update annotation - testing ge_anatomyid, ge_anatomy_term & ge_anatomy_text (action=edit,creatorid=solomon,phisid=roi_ua_testX19776P,imageid=emage_EMAGE_1218.1,ge_anatomyid = (EMAP:51447, EMAP:514456), ge_anatomy_term = (test GE term, test GE term), ge_anatomy_text = (test GE term text, test GE term text 2))", function( assert ) {
...
QUnit.test( "Delete annotation (action=delete,creatorid=solomon,phisid=roi_ua_testX19776P,imageid=emage_EMAGE_1218.1)", function( assert ) {
