...
// test bad param
QUnit.test("Testing bad param", function (assert) {
    ...
    var version = "104";
    var resultNo = 1;
    var phisid = "roi_ua_testX19776Xyy";
    var creatorid = "TestUser";
    var imageid = "8_komp2_307138";
    var x_values = {x_value: [33.333333333333336, 63.75661375661376]};
    var y_values = {y_value: [42.79661026949152, 70.33898305084746]};
    ...
    var data = $.param({publish: publish, action: action, version: version, imageid: imageid, creatorid: creatorid, phisid: phisid,
        x_value: [33.333333333333336, 63.75661375661376], y_value: [42.79661026949152, 70.33898305084746],
        z_value: [0, 0], dpt_anatomy_term: ["body cavity or lining", "anatomical cluster"], dpt__anatomyid: ["EMAP:3144", "EMAP:31445"]}, true);
    ...
    var iqs_response = iqs_request.done(function (response) {
        ...
        assert.equal(response_status, "fail", "Failed... as expected!");
...
// test missing publish param
QUnit.test("Testing missing publish param", function (assert) {
...
QUnit.test("Add annotation (action=create,creatorid=TestUser,phisid=roi_ua_testX19776,imageid=8_komp2_307138, publish: false)", function (assert) {
...
//Annotation APIs
QUnit.test("Update annotation - dpt_anatomyid, dpt_anatomy_term and dpt_anatomy_text endpoints (action=edit,creatorid=TestUser,phisid=roi_ua_testX19776,imageid=emage_EMAGE_1218.1, publish: false)", function (assert) {
...
QUnit.test("Update annotation - testing phenotypeid, phenotype_text & phenotype_terms (action=edit,creatorid=TestUser,phisid=roi_ua_testX19776,imageid=emage_EMAGE_1218.1, phenotypeid = (EMAP:41447, EMAP:414456),  phenotype_terms = (cornea ulcer, cornea opacity), phenotype_text = (cornea ulcer text,cornea opacity text))",
        function (assert) {
...
//Annotation APIs - editing annotation
QUnit.test("Update annotation - testing ge_anatomyid, ge_anatomy_term & ge_anatomy_text (action=edit,creatorid=TestUser,phisid=roi_ua_testX19776,imageid=emage_EMAGE_1218.1,ge_anatomyid = (EMAP:51447, EMAP:514456), ge_anatomy_term = (test GE term, test GE term), ge_anatomy_text = (test GE term text, test GE term text 2))", function (assert) {
...
QUnit.test("Delete annotation (action=delete,creatorid=TestUser,phisid=roi_ua_testX19776,imageid=emage_EMAGE_1218.1)", function (assert) {
    ...
    var data = $.param({action: action, version: version, imageid: imageid, creatorid: creatorid, phisid: phisid, publish: publish}, true);
