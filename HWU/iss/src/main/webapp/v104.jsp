<html>
    <body>
        ...
        <h3>Instructions</h3>
        <div>
            <p>This is API v104, to use it append &version=104 to your URL.</p>             
        </div>
        ...
        <div>
            <h4>Examples</h4>
            <ol>
                <li><a href="<%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Id?version=104"><%= org.bisel.phis.iss.client.GetISSURL.getURL()%>Id?version=104</a></p></li>
            </ol>
        </div>                                  
    </body>
</html>
