 ...
 * @author kcm
 */
@WebServlet(name = "v102GRs", urlPatterns = {"/v102GRs"})
public class v102GRs extends HttpServlet {

    private static final String url = GetHost.getEBI("102") + "getRois?"; // stem of every SOLR query
