 ...
 * @author kcm
 */
@WebServlet(name = "v100GCs", urlPatterns = {"/v100GCs"})
public class v100GCs extends HttpServlet {

    private static final String url = GetHost.getEBI("100")+"getChannels?"; // stem of every SOLR query
