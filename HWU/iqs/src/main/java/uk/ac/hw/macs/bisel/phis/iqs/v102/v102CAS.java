 ...
 * @author kcm
 */
@WebServlet(name = "v102CAS", urlPatterns = {"/v102CAS"})
public class v102CAS extends HttpServlet {
    
    private static final String url = GetHost.getEBI("102")+"getComplexAutosuggest?"; // stem of every SOLR query
