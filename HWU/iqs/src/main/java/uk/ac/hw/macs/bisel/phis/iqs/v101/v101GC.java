 ...
 * @author kcm
 */
@WebServlet(name = "v101GC", urlPatterns = {"/v101GC"})
public class v101GC extends HttpServlet {
    
    private static final String url = GetHost.getEBI("101")+"getChannel?"; // stem of every SOLR query
