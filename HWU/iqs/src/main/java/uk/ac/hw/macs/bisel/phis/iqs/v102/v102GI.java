 ...
 * @author kcm
 */
@WebServlet(name = "v102GI", urlPatterns = {"/v102GI"})
public class v102GI extends HttpServlet {

    private static final String url = GetHost.getEBI("102")+"getImage?"; // stem of every SOLR query
