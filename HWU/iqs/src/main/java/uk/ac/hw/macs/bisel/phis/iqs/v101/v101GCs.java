 ...
 * @author kcm
 */
@WebServlet(name = "v101GCs", urlPatterns = {"/v101GCs"})
public class v101GCs extends HttpServlet {

    private static final String url = GetHost.getEBI("101")+"getChannels?"; // stem of every SOLR query
