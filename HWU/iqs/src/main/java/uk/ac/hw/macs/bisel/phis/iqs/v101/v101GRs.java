 ...
 * @author kcm
 */
@WebServlet(name = "v101GRs", urlPatterns = {"/v101GRs"})
public class v101GRs extends HttpServlet {

    private static final String url = GetHost.getEBI("101") + "getRois?"; // stem of every SOLR query
