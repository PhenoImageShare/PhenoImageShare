 ...
 * @author kcm
 */
@WebServlet(name = "v100GRs", urlPatterns = {"/v100GRs"})
public class v100GRs extends HttpServlet {

    private static final String url = GetHost.getEBI("100")+"getRois?"; // stem of every SOLR query
