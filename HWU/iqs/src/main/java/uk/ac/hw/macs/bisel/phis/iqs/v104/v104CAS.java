 ...
 * @author kcm
 */
@WebServlet(name = "v104CAS", urlPatterns = {"/v104CAS"})
public class v104CAS extends HttpServlet {

    private static final String url = GetHost.getEBI("104") + "getComplexAutosuggest?"; // stem of every SOLR query
