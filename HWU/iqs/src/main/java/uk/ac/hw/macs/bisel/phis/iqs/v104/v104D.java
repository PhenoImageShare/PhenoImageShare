 ...
 * @author kcm
 */
@WebServlet(name = "v104D", urlPatterns = {"/v104D"})
public class v104D extends HttpServlet {

    private static final String url = GetHost.getEBI("104") + "download?"; // stem of every SOLR query
