 ...
 * @author kcm
 */
@WebServlet(name = "v101GIs", urlPatterns = {"/v101GIs"})
public class v101GIs extends HttpServlet {

    private static final String url = GetHost.getEBI("101") + "getImages?"; // stem of every SOLR query
