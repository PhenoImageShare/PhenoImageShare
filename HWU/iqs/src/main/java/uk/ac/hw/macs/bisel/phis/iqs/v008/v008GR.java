 ...
 * @author kcm
 */
@WebServlet(name = "v008GR", urlPatterns = {"/v008GR"})
public class v008GR extends HttpServlet {

    private static final String url = GetHost.getEBI("008")+"getRoi?"; // stem of every SOLR query
