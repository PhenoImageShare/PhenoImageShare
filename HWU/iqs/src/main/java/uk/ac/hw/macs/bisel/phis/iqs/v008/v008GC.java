 ...
 * @author kcm
 */
@WebServlet(name = "v008GC", urlPatterns = {"/v008GC"})
public class v008GC extends HttpServlet {
    
    private static final String url = GetHost.getEBI("008")+"getChannel?"; // stem of every SOLR query
