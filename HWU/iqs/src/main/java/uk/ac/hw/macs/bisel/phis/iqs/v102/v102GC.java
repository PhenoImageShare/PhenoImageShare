 ...
 * @author kcm
 */
@WebServlet(name = "v102GC", urlPatterns = {"/v102GC"})
public class v102GC extends HttpServlet {
    
    private static final String url = GetHost.getEBI("102")+"getChannel?"; // stem of every SOLR query
