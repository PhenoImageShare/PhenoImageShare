 ...
 * @author kcm
 */
@WebServlet(name = "v103D", urlPatterns = {"/v103D"})
public class v103D extends HttpServlet {

    private static final String url = GetHost.getEBI("103") + "download?"; // stem of every SOLR query
