 ...
 * @author kcm
 */
@WebServlet(name = "v008GI", urlPatterns = {"/v008GI"})
public class v008GI extends HttpServlet {

    private static final String url = GetHost.getEBI("008")+"getImage?"; // stem of every SOLR query
