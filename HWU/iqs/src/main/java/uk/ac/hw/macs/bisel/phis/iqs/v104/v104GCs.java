 ...
 * @author kcm
 */
@WebServlet(name = "v104GCs", urlPatterns = {"/v104GCs"})
public class v104GCs extends HttpServlet {

    private static final String url = GetHost.getEBI("104")+"getChannels?"; // stem of every SOLR query
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while (allParams.hasMoreElements()) {
            ...
            } else if (param.equalsIgnoreCase("imageId")) { // ID of channel
