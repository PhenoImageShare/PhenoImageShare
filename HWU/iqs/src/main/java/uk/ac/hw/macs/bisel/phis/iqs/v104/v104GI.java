 ...
 * @author kcm
 */
@WebServlet(name = "v104GI", urlPatterns = {"/v104GI"})
public class v104GI extends HttpServlet {

    private static final String url = GetHost.getEBI("104")+"getImage?"; // stem of every SOLR query
