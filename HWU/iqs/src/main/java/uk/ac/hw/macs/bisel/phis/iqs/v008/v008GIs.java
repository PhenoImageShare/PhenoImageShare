 ...
 * @author kcm
 */
@WebServlet(name = "v008GIs", urlPatterns = {"/v008GIs"})
public class v008GIs extends HttpServlet {

    private static final String url = GetHost.getEBI("008")+"getImages?"; // stem of every SOLR query
