 ...
 * @author kcm
 */
@WebServlet(name = "v100GIs", urlPatterns = {"/v100GIs"})
public class v100GIs extends HttpServlet {

    private static final String url = GetHost.getEBI("100")+"getImages?"; // stem of every SOLR query
