 ...
 * @author kcm
 */
@WebServlet(name = "v101GI", urlPatterns = {"/v101GI"})
public class v101GI extends HttpServlet {

    private static final String url = GetHost.getEBI("101")+"getImage?"; // stem of every SOLR query
