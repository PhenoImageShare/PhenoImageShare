 ...
 * @author kcm
 */
@WebServlet(name = "v103S", urlPatterns = {"/v103S"})
public class v103S extends HttpServlet {

    private static final String url = GetHost.getEBI("103") + "similar?"; // stem of every SOLR query
