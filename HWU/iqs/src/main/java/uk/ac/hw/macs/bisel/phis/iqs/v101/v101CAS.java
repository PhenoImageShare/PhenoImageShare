 ...
 */
package uk.ac.hw.macs.bisel.phis.iqs.v101;
 ...
 * @author kcm
 */
@WebServlet(name = "v101CAS", urlPatterns = {"/v101CAS"})
public class v101CAS extends HttpServlet {
    
    private static final String url = GetHost.getEBI("101")+"getComplexAutosuggest?"; // stem of every SOLR query
