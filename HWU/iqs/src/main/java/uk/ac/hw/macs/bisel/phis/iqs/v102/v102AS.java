 ...
 * @author kcm
 */
@WebServlet(name = "v102AS", urlPatterns = {"/v102AS"})
public class v102AS extends HttpServlet {

    private static final String url = GetHost.getEBI("102")+"getAutosuggest?"; // stem of every SOLR query
