 ...
 * @author kcm
 */
@WebServlet(name = "v101AS", urlPatterns = {"/v101AS"})
public class v101AS extends HttpServlet {

    private static final String url = GetHost.getEBI("101")+"getAutosuggest?"; // stem of every SOLR query
