 ...
 * @author kcm
 */
@WebServlet(name = "v101GR", urlPatterns = {"/v101GR"})
public class v101GR extends HttpServlet {

    private static final String url = GetHost.getEBI("101")+"getRoi?"; // stem of every SOLR query
