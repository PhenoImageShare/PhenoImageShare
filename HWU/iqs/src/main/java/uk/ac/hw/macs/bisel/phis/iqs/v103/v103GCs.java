 ...
 * @author kcm
 */
@WebServlet(name = "v103GCs", urlPatterns = {"/v103GCs"})
public class v103GCs extends HttpServlet {

    private static final String url = GetHost.getEBI("103")+"getChannels?"; // stem of every SOLR query
