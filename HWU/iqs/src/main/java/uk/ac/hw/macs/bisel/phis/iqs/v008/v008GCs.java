 ...
 * @author kcm
 */
@WebServlet(name = "v008GCs", urlPatterns = {"/v008GCs"})
public class v008GCs extends HttpServlet {

    private static final String url = GetHost.getEBI("008")+"getChannels?"; // stem of every SOLR query
