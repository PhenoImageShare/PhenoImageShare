 ...
 * @author kcm
 */
@WebServlet(name = "v102GCs", urlPatterns = {"/v102GCs"})
public class v102GCs extends HttpServlet {

    private static final String url = GetHost.getEBI("102")+"getChannels?"; // stem of every SOLR query
