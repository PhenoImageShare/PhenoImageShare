 ...
 * @author kcm
 */
@WebServlet(name = "v104S", urlPatterns = {"/v104S"})
public class v104S extends HttpServlet {

    private static final String url = GetHost.getEBI("104") + "similar?"; // stem of every SOLR query
