 ...
 * @author kcm
 */
@WebServlet(name = "v100GI", urlPatterns = {"/v100GI"})
public class v100GI extends HttpServlet {

    private static final String url = GetHost.getEBI("100")+"getImage?"; // stem of every SOLR query
