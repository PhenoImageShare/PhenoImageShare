 ...
 * @author kcm
 */
@WebServlet(name = "v104GIs", urlPatterns = {"/v104GIs"})
public class v104GIs extends HttpServlet {

    private static final String url = GetHost.getEBI("104") + "getImages?"; // stem of every SOLR query
