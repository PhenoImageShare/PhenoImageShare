 ...
 * @author kcm
 */
@WebServlet(name = "v100GR", urlPatterns = {"/v100GR"})
public class v100GR extends HttpServlet {

    private static final String url = GetHost.getEBI("100")+"getRoi?"; // stem of every SOLR query
