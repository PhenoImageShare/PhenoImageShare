 ...
 * @author kcm
 */
@WebServlet(name = "v104GRs", urlPatterns = {"/v104GRs"})
public class v104GRs extends HttpServlet {

    private static final String url = GetHost.getEBI("104") + "getRois?"; // stem of every SOLR query
