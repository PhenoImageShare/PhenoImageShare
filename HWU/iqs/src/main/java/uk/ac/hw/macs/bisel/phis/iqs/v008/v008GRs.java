 ...
 * @author kcm
 */
@WebServlet(name = "v008GRs", urlPatterns = {"/v008GRs"})
public class v008GRs extends HttpServlet {

    private static final String url = GetHost.getEBI("008")+"getRois?"; // stem of every SOLR query
