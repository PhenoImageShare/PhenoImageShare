 ...
 * @author kcm
 */
@WebServlet(name = "v102GR", urlPatterns = {"/v102GR"})
public class v102GR extends HttpServlet {

    private static final String url = GetHost.getEBI("102")+"getRoi?"; // stem of every SOLR query
