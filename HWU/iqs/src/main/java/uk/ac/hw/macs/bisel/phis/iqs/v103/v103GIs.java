 ...
 * @author kcm
 */
@WebServlet(name = "v103GIs", urlPatterns = {"/v103GIs"})
public class v103GIs extends HttpServlet {

    private static final String url = GetHost.getEBI("103") + "getImages?"; // stem of every SOLR query
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while (allParams.hasMoreElements()) {
            ...
            } else if (param.equalsIgnoreCase("phenotype")) { // deal with phenotypes
            ...
            // prioritisation
            } else if(param.equalsIgnoreCase("-anatomy")) {
                if (!first) {
                    queryURL += "&";
                }
                queryURL += "-anatomy=" + URLEncoder.encode(params.get("-anatomy")[0], "UTF-8");
