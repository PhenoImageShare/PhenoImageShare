 ...
 * @author kcm
 */
@WebServlet(name = "v104GC", urlPatterns = {"/v104GC"})
public class v104GC extends HttpServlet {
    
    private static final String url = GetHost.getEBI("104")+"getChannel?"; // stem of every SOLR query
