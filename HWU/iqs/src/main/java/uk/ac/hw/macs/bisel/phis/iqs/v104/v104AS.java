 ...
 * @author kcm
 */
@WebServlet(name = "v104AS", urlPatterns = {"/v104AS"})
public class v104AS extends HttpServlet {

    private static final String url = GetHost.getEBI("104") + "getAutosuggest?"; // stem of every SOLR query
