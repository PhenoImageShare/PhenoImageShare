 ...
 * @author kcm
 */
@WebServlet(name = "v103GC", urlPatterns = {"/v103GC"})
public class v103GC extends HttpServlet {
    
    private static final String url = GetHost.getEBI("103")+"getChannel?"; // stem of every SOLR query
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while (allParams.hasMoreElements()) {
            ...
            } else if (param.equalsIgnoreCase("id")) { // ID of channel
