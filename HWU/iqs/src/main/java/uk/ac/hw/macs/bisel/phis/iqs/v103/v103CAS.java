 ...
 * @author kcm
 */
@WebServlet(name = "v103CAS", urlPatterns = {"/v103CAS"})
public class v103CAS extends HttpServlet {

    private static final String url = GetHost.getEBI("103") + "getComplexAutosuggest?"; // stem of every SOLR query
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while (allParams.hasMoreElements()) {
            ...
            } else if (param.toLowerCase().contains("callback")) {
                callback = params.get(param)[0];
