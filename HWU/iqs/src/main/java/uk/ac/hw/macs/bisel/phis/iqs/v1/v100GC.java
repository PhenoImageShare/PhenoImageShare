 ...
 * @author kcm
 */
@WebServlet(name = "v100GC", urlPatterns = {"/v100GC"})
public class v100GC extends HttpServlet {
    
    private static final String url = GetHost.getEBI("100")+"getChannel?"; // stem of every SOLR query
