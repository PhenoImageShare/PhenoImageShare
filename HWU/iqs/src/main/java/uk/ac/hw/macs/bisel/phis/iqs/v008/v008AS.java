 ...
 */
package uk.ac.hw.macs.bisel.phis.iqs.v008;
 ...
 * @author kcm
 */
@WebServlet(name = "v008AS", urlPatterns = {"/v008AS"})
public class v008AS extends HttpServlet {

    private static final String url = GetHost.getEBI("008")+"getAutosuggest?"; // stem of every SOLR query
