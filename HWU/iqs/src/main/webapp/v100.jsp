...
<html>
    <body>
        ...
        <div>
            ...
            <p>Hitting EBI endpoint: <%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getEBI("100")%></p>
        </div>
        ...
        <h3>Instructions</h3>
        <div>
            <p>This is v100, to use it append &version=100 to your URL.</p>             
        </div>
        ...
        <div>            
            ...
            <p>For unit tests see <a tab="_blank" href="tests/index100.html">here</a>.</p>            
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr style="background-color: orange;">
                        ...
                        <td><var> 007 </var></td>
                        <td><var>100 | 007</var></td>
                    </tr>                    
                </tbody>
            </table>
            <h4>Examples:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImage?imageId=wtsi_komp2_112968&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImage?imageId=wtsi_komp2_112968&version=100</a></li>
            </ol>
        ...
        <div>
            ...
            <h4>Examples:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?term=eye&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?term=eye&version=100</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&version=100</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&start=1&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&start=1&version=100</a></li>                
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=cataracts&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=cataracts&version=100</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?anatomy=eye&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?anatomy=eye&version=100</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?gene=Spns2&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?gene=Spns2&version=100</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRoi?id=wtsi_roi_komp2_roi_112003_0&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRoi?id=wtsi_roi_komp2_roi_112003_0&version=100</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?imageId=wtsi_komp2_112003&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?imageId=wtsi_komp2_112003&version=100</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannel?id=wtsi_channel_komp2_channel_112003_0&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannel?id=wtsi_channel_komp2_channel_112003_0&version=100</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannels?imageId=wtsi_komp2_112003&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannels?imageId=wtsi_komp2_112003&version=100</a></li>
            </ol>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getAutosuggest?term=ey&version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getAutosuggest?term=ey&version=100</a></li>
            </ol>            
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getDataReleases?version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getDataReleases?version=100</a></li>
            </ol>
        </div>            
       ...
       <hr />
        ...
        <div>
            <h4>Examples</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getSpatialRelns?version=100"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getSpatialRelns?version=100</a></p></li>
            </ol>
        </div>              
