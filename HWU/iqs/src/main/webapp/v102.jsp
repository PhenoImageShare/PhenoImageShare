...
<html>
    <body>
        ...
        <div>
            ...
            <p>Hitting EBI endpoint: <%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getEBI("102")%></p>
        </div>
        ...
        <h3>Instructions</h3>
        <div>
            <p>This is version <%=applVersion%>, to use it append &version=102 to your URL.</p>             
        </div>
        ...
        <div>            
            ...
            <p>For unit tests see <a tab="_blank" href="tests/index102.html">here</a>.</p>            
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><var> 101 </var></td>
                        <td><var>101 | 102</var></td>
                    </tr>                    
                </tbody>
            </table>
            <h4>Examples:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImage?imageId=wtsi_komp2_112968&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImage?imageId=wtsi_komp2_112968&version=102</a></li>
            </ol>
        ...
        <div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <!-- v102 -->
                    <tr>
                        <td style="background-color: orange;">lastRoiEditAfter</td>
                        <td><var>Date</var></td>
                        <td>false</td>
                    ...
                    <tr>
                        <td style="background-color: orange;">lastRoiEditBefore</td>
                        <td><var>Date</var></td>
                        <td>false</td>
            ...
            <h4>Examples:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?term=eye&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?term=eye&version=102</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&version=102</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&start=1&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010254&start=1&version=102</a></li>                
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=cataracts&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=cataracts&version=102</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?anatomy=eye&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?anatomy=eye&version=102</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?gene=Spns2&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?gene=Spns2&version=102</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRoi?id=wtsi_roi_komp2_roi_112003_0&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRoi?id=wtsi_roi_komp2_roi_112003_0&version=102</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?imageId=wtsi_komp2_112003&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?imageId=wtsi_komp2_112003&version=102</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?createdAfter=1976-03-06T23:59:59.999Z&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?createdAfter=1976-03-06T23:59:59.999Z&version=102</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannel?id=wtsi_channel_komp2_channel_112003_0&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannel?id=wtsi_channel_komp2_channel_112003_0&version=102</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannels?imageId=wtsi_komp2_112003&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannels?imageId=wtsi_komp2_112003&version=102</a></li>
            </ol>
        ...
        <div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <!-- v102 -->
                    <tr>
                        <td style="background-color: orange;">hostName</td>
                        <td><var>String</var></td>
                        <td> false </td>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getAutosuggest?term=ey&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getAutosuggest?term=ey&version=102</a></li>
            </ol>            
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getComplexAutosuggest?term=ey&version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getComplexAutosuggest?term=ey&version=102</a></li>
            </ol>            
        </div>        
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getDataReleases?version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getDataReleases?version=102</a></li>
            </ol>
        </div>            
        ...
        <div>
            ...
            <div>
                <h4>Examples</h4>
                <ol>
                    <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getSpatialRelns?version=102"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getSpatialRelns?version=102</a></p></li>
                </ol>
            </div>              
