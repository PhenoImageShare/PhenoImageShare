...
<html>
    <body>
        ...
        <div>
            ...
            <p>Hitting EBI endpoint: <%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getEBI("104")%></p>
        </div>
        ...
        <h3>Instructions</h3>
        <div>
            <p>This is version <%=applVersion%>, to use it append &version=104 to your URL.</p>             
        </div>
        ...
        <div>            
            ...
            <p>For unit tests see <a tab="_blank" href="tests/index104.html">here</a>.</p>            
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><var> 103 </var></td>
                        <td><var>103 | 104</var></td>
                    </tr>                    
                </tbody>
            </table>
            <h4>Examples:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImage?imageId=8_komp2_307138&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImage?imageId=8_komp2_307138&version=104</a></li>
            </ol>
        ...
        <div>
            ...
            <h4>Examples:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?term=eye&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?term=eye&version=104</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010454&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010454&version=104</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010454&start=1&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=MP:0010454&start=1&version=104</a></li>                
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=cataracts&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?phenotype=cataracts&version=104</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?anatomy=eye^1&anatomy=heart&anatomy=liver^2&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?anatomy=eye^1&anatomy=heart&anatomy=liver^2&version=104</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?gene=Spns2&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getImages?gene=Spns2&version=104</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRoi?id=8_roi_komp2_roi_307138_793338&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRoi?id=8_roi_komp2_roi_307138_793338&version=104</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?imageId=wtsi_komp2_112003&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?imageId=wtsi_komp2_112003&version=104</a></li>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?createdAfter=1976-03-06T23:59:59.999Z&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getRois?createdAfter=1976-03-06T23:59:59.999Z&version=104</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannel?id=wtsi_channel_komp2_channel_112003_0&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannel?id=wtsi_channel_komp2_channel_112003_0&version=104</a></li>
            </ol>
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannels?imageId=wtsi_komp2_112003&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getChannels?imageId=wtsi_komp2_112003&version=104</a></li>
            </ol>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getAutosuggest?term=ey&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getAutosuggest?term=ey&version=104</a></li>
            </ol>            
        </div>
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getComplexAutosuggest?term=ey&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getComplexAutosuggest?term=ey&version=104</a></li>
            </ol>            
        </div>        
        ...
        <div>
            ...
            <h4>Example:</h4>
            <ol>
                <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getDataReleases?version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getDataReleases?version=104</a></li>
            </ol>
        </div>            
        ...
        <div>
            ...
            <table class="table table-striped">
                ...
                <h4>Example:</h4>
                <ol>
                    <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>similar?imageId=wtsi_komp2_213108&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>similar?imageId=wtsi_komp2_213108&version=104</a></li>
                </ol>
        </div>             
        ...
        <div>
            ...
            <table class="table table-striped">
                ...
                <h4>Example:</h4>
                <ol>
                    <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>download?imageId=wtsi_komp2_213108&version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>download?imageId=wtsi_komp2_213108&version=104</a></li>
                </ol>
        </div> 
                ...
                <div>
                    ...
                    <div>
                        <h4>Examples</h4>
                        <ol>
                            <li><a href="<%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getSpatialRelns?version=104"><%= uk.ac.hw.macs.bisel.phis.iqs.GetHost.getURI()%>getSpatialRelns?version=104</a></p></li>
                        </ol>
                    </div>              
