 ...
 * @author kcm
 */
@WebServlet(name = "v007GCs", urlPatterns = {"/v007GCs"})
public class v007GCs extends HttpServlet {

    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.7/rest/getChannels?"; // stem of every SOLR query
