 ...
 * @author kcm
 */
public class v004GCs extends HttpServlet {

    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.4/rest/getChannels?"; // stem of every SOLR query
