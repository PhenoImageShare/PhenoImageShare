 ...
 * @author kcm
 */
//@WebServlet(name = "GetChannels", urlPatterns = {"/GetChannels"})
public class GetChannels extends HttpServlet {

    private static final String url = "http://dev.phenoimageshare.org/data/rest/getChannels?"; // stem of every SOLR query
     ...
     *
     * 
     * This has no need for pagination as only 1 channel can be returned per query
     *
