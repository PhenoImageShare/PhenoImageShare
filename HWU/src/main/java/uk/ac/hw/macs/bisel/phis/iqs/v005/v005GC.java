 ...
 * @author kcm
 */
@WebServlet(name = "v005GC", urlPatterns = {"/v005GC"})
public class v005GC extends HttpServlet {
    
    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.5/rest/getChannel?"; // stem of every SOLR query
