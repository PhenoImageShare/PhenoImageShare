 ...
 * @author kcm
 */
@WebServlet(name = "v005GI", urlPatterns = {"/v005GI"})
public class v005GI extends HttpServlet {

    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.5/rest/getImage?"; // stem of every SOLR query
