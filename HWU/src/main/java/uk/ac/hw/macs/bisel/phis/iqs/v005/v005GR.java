 ...
 * @author kcm
 */
@WebServlet(name = "v005GR", urlPatterns = {"/v005GR"})
public class v005GR extends HttpServlet {

    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.5/rest/getRoi?"; // stem of every SOLR query
