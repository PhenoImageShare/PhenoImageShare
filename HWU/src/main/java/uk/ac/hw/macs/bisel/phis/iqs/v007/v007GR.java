 ...
 * @author kcm
 */
@WebServlet(name = "v007GR", urlPatterns = {"/v007GR"})
public class v007GR extends HttpServlet {

    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.7/rest/getRoi?"; // stem of every SOLR query
