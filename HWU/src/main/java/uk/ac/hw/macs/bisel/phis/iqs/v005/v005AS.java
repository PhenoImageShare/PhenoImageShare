 ...
 * @author kcm
 */
@WebServlet(name = "v005AS", urlPatterns = {"/v005AS"})
public class v005AS extends HttpServlet {

    private static final String url = "http://beta.phenoimageshare.org/data/v0.0.5/rest/getAutosuggest?"; // stem of every SOLR query
