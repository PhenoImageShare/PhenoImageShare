...
public class PhisSubmissionException extends Exception{

	private static final long serialVersionUID = 1779250515514678327L;
	...
	public PhisSubmissionException(String message){
		super(message);
	}
