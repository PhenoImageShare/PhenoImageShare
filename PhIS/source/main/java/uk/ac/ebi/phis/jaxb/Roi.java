 ...
 *         &lt;element name="edit_date" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="depicted_anatomical_structure" type="{http://www.example.org/phisSchema}AnnotationArray" minOccurs="0"/>
 *         &lt;element name="anatomical_structure_with_expression" type="{http://www.example.org/phisSchema}AnnotationArray" minOccurs="0"/>
...
public class Roi {
    ...
    @XmlElement(name = "anatomical_structure_with_expression")
    protected AnnotationArray anatomicalStructureWithExpression;
    ...
    /**
     * Gets the value of the anatomicalStructureWithExpression property.
     * 
     * @return
     *     possible object is
     *     {@link AnnotationArray }
     *     
     */
    public AnnotationArray getAnatomicalStructureWithExpression() {
        return anatomicalStructureWithExpression;
    }

    /**
     * Sets the value of the anatomicalStructureWithExpression property.
     * 
     * @param value
     *     allowed object is
     *     {@link AnnotationArray }
     *     
     */
    public void setAnatomicalStructureWithExpression(AnnotationArray value) {
        this.anatomicalStructureWithExpression = value;
    }
