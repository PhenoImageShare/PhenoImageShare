...
public class TracerXmlGenerator {
	...
	public void exportImages() throws IOException{
        ...
        String command = "SELECT sl.sb_id, sl.sbname, l.name as source, c.name as chr_name, si.position, si.strand, "
        		...
        		+ "ei.display_mode='public' AND sl.display_mode='public' LIMIT 10000000";
        ...
        try {
	        ...
	        while ( res.next()){
	    		...
	    		if (dimensions != null){ //index info only if the image could be loaded 	    		
	    			...
	    			expressed.setGenomeAssembly(EnsemblClient.LATEST_MOUSE_GENOME_ASSEMBLY);
	    			
	    			// Get genes from ensembl
	    			// TODO Does it make sense to put the flanking genes in the export? I think I should do this at indexing time directly. 
