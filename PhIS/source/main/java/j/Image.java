 ...
 *         &lt;element name="mutant_genotype_traits" type="{http://www.example.org/phisSchema}GeneticTraitArray"/>
 ...
 *         &lt;element name="depicted_anatomical_structure" type="{http://www.example.org/phisSchema}AnatomyArray" minOccurs="0"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Image {
    ...
    @XmlElement(name = "mutant_genotype_traits", required = true)
    protected GeneticTraitArray mutantGenotypeTraits;
    ...
    protected AnatomyArray depictedAnatomicalStructure;
     ...
     *     
     */
    public GeneticTraitArray getMutantGenotypeTraits() {
     ...
     *     
     */
    public void setMutantGenotypeTraits(GeneticTraitArray value) {
     ...
     *     
     */
    public AnatomyArray getDepictedAnatomicalStructure() {
     ...
     *     
     */
    public void setDepictedAnatomicalStructure(AnatomyArray value) {
